 ...
 * @param to
 */
export function handleChangeDate(key:string,e: any,  filter: any, setFilter: Dispatch<SetStateAction<any>>){
    let temp = lodash.merge({}, filter);
    if (e) {
...
export function saveFileFromBlob(res: any, filename: string){
